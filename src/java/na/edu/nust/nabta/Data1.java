...
public class Data1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        agreement_status = request.getParameter("Astate");
        ...
        HttpSession ses = request.getSession(true);
                ...
                if (agreement_status == null || agreement_status.trim().equals("")) {
                    ses.setAttribute("Astate", agreement_status);
                    response.sendRedirect("index.jsp");
                } else if (agreement_status.trim().equals("agreed")) {
                    ses.setAttribute("Astate", agreement_status);
